/**
 * Inline SVG markup for the editor chrome.
 *
 * Kept as strings rather than components so the library stays framework free
 * and the bundle carries no icon dependency.
 */
export const ICON = {
